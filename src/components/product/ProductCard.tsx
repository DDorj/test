    ...
    <div className="group relative bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl overflow-hidden hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
      ...
      <div className="relative">
        <Link href={`/product/${product?.slug}`} className="relative block">
          {/* Fixed Height Container - Consistent across all cards */}
          <div className="h-56 sm:h-64 md:h-72 w-full bg-neutral-50 dark:bg-neutral-900 relative overflow-hidden rounded-t-xl flex items-center justify-center transition-colors duration-300">
        ...
        {/*      setViewerOpen(true)*/}
        {/*    }}*/}
        {/*    className="absolute inset-0 bg-black/0 hover:bg-black/10 transition-colors duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100 rounded-t-xl"*/}
        {/*    aria-label="View full size image"*/}
        {/*  >*/}
        {/*    <div className="w-12 h-12 flex items-center justify-center bg-white/90 dark:bg-neutral-800/90 backdrop-blur-sm rounded-full shadow-lg transform group-hover:scale-110 transition-transform duration-300">*/}
